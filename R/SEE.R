...
SEE<-function(data,id,date){
  list.of.packages <- c("plyr", "dplyr", "tableone", "tidyverse", "data.table", "latticeExtra", "factoextra", "spatstat")
...
main_data2$median_cluster <- ifelse(is.na(main_data2$median_cluster), p3$median_cluster, main_data2$median_cluster)
